...
function submit() {
    ...
    let c = (number-32)*5/9;
    let  = document.getElementById("result").innerHTML= result
  ...
  if(!number)  result.innerHTML=("Please enter a number ")
    ...
    { result.innerHTML=("it cannot be colder than this" +" "+ c);}
    //alert("it cannot be colder than this" +" "+ c)

    else if (c < 16 ) {
      result.innerHTML=("It is cold,wear Jacket" +" "+ c);
     // alert("it cannot be colder than this" +" "+ c);
    }

    else if (c>=16 && c<21) {
        //alert("It is warm,wear T-shirt and Jeans" +" "+ c);
        result.innerHTML=("It is warm, wear T-shirt and Jeans" +" "+ c)
    }
        
     else {
       result.innerHTML("It is hot,wear shorts" +" "+ c);
